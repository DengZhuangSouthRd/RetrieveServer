...
/** \defgroup arraytypedefs Global array typedefs
  ...
  *
  * \c ArrayRowsColsType where \c Rows and Çols can be \c 2,\c 3,\c 4 for fixed size square matrices or \c X for dynamic size,
  * and where \c Type can be \c i for integer, \c f for float, \c d for double, çf for complex float, çd
  * for complex double.
  *
